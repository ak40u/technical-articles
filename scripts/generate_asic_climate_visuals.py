...
LOCALES = {
    "ru": {
        ...
        "economics": {
            ...
            "snapshot": "Снимок для 3 асиков · 28,5 дня · 1,85 GH/s каждый",
            "stats": [("1 292,8 кВт·ч", "ПОЛЕЗНОЕ ТЕПЛО"), ("5 443 ₽", "СЧЕТ ЗА СВЕТ"), ("7 057 ₽", "КОМПЕНСАЦИЯ ETC"), ("−1 615 ₽", "СТОИМОСТЬ ТЕПЛА")],
    ...
    "en": {
        ...
        "economics": {
            ...
            "snapshot": "Snapshot for 3 ASICs · 28.5 days · 1.85 GH/s each",
            "stats": [("1,292.8 kWh", "USEFUL HEAT"), ("RUB 5,443", "POWER BILL"), ("RUB 7,057", "ETC OFFSET"), ("−RUB 1,615", "HEATING COST")],
