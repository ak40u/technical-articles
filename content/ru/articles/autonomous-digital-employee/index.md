...
![Техническая схема исследовательского конвейера: от идеи и desk-check до forward paper, live micro и решения владельца о масштабировании](hypothesis-pipeline.svg)

*Конвейер гипотез. Любая ветвь может закончиться в кладбище с записанной причиной смерти.*
...
![Архитектура цифрового сотрудника: launchd запускает смены, watchdog поднимает incident-смену, а рабочие контуры соединяют Telegram, прод, discovery, paper и память](system-architecture.svg)

*Реальная архитектура проекта. Расписание и watchdog работают отдельно от рассуждающих смен.*
...
![Контур автономной смены: сбор фактов, математический pulse, поиск похожих эпизодов, один из трёх вердиктов, действие, запись опыта и отчёт](autonomy-loop.svg)

*Контур инженерной интуиции. Следующая смена получает факты, исходы решений и проверяемые прогнозы предыдущей.*
