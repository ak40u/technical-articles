...
Рыночные предложения в регионе начинаются примерно от [160 000 ₽](https://voronezh.profgazservis.ru/) за газификацию дома и от [250 000 ₽](https://gazbyt-torg.ru/pdet-tsena-gazifikatsii-doma-voronezh/) за вариант «под ключ». Для одного дома разумно держать предварительный диапазон **160 000–250 000 ₽**. Для комплекса из пяти разнесенных зон с длинными траншеями, теплотрассами или несколькими приборами ориентир **250 000–500 000 ₽** выглядит безопаснее до получения проекта и замера трассы.
...
| Газ, один дом | 160 000–250 000 ₽ | около 12 700 ₽ газа без учета обслуживания | 4,1–6,3 года |
| Газ, пять разнесенных зон | 250 000–500 000 ₽ | от 12 700 ₽ плюс потери и обслуживание | 6,3–12,7 года |

Строка с асиками предполагает, что электрический ввод, сервер, датчики и умные розетки уже есть, как в описываемом проекте. Для нового объекта их стоимость нужно прибавить. Газовые диапазоны тоже предварительные: окончательную смету определят технические условия, длина трассы и выбранная схема отопления пяти зон.
